	...
	<h1>Freelancer İş ve Çalışan Arama Sitesi
		...
		<div class="tablo">
			<form action="arama.php" method="post">
			  ...
			  <h2>İstediğin İşin Özelliklerine Göre Çalışan Ara</h2>
			  <br>
			  <br>
			   
			  <label for="meslek">Hangi Mesleğe Tercih Ettiğinizi Seçiniz:</label>
			  ...
			  <label for="tecrube">Hangi Tecrübeye Sahip Çalışan Aradığınızı Seçin:</label>
			  ...
			  <br>
				...
				<input type="text" id="alan" name="alan" placeholder="Alanınızı Belirtin" required><br>
				<br><br>
